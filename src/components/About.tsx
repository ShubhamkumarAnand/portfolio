    ...
    <div className="container m-10 mx-auto flex h-screen space-x-24">
      <section className="mx-px mt-10 w-1/2">
        ...
        <section className="container flex space-x-6">
          <button className="rounded-xl border-4 p-1 transition delay-75 duration-300 ease-in-out hover:-translate-y-2 hover:scale-110 hover:bg-gray-600">
        ...
        <br />
        <button className="flex flex-row rounded-xl bg-red-700 p-4 text-3xl shadow transition delay-100 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:border-none hover:bg-green-700">
          <Link
